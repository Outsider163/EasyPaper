...
- FMS 管理科学合并命令：`npm run catalog:merge:fms`；
- 全量目录发布命令：
  `npm run catalog:publish -- <全标签.csv|tsv|json> <版本> [目录名称]`；
- 发布前校验命令：`npm run catalog:verify`。

当前服务器目录版本为 `2025-2026-full.7`，共 8,775 条合并记录。除国际 CCF A/B/C 和云南财经大学目录外，已加入 CCF 2025 国内期刊 T1/T2/T3（68 本）、北大核心、CSSCI 来源/扩展版、中国科技核心、CSCD 核心/扩展库，以及 43 个通过数量核验的中国科协高质量期刊学科；管理科学共 1,277 种，覆盖中文 T1/T2 和国际 A/B/C/D。
