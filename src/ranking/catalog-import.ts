...
const HEADER_ALIASES = {
  ...
  cssciExtendedLabels: ['cssciextendedlabels', 'cssci扩展版标签', 'cssci扩展标签', '南大扩展版标签'],
  cstpcdLabels: ['cstpcdlabels', '中国科技核心标签', '科技核心标签', '中国科技核心', '科技核心', 'cstpcd'],
  cscdCoreLabels: ['cscdcorelabels', 'cscd核心库标签', 'cscd核心库', '中国科学引文数据库核心库'],
  cscdExtendedLabels: ['cscdextendedlabels', 'cscd扩展库标签', 'cscd扩展库', '中国科学引文数据库扩展库'],
  castTierLabels: ['casttierlabels', '中国科协高质量期刊标签', '中国科协标签', '科协高质量期刊标签'],
...
function serializeVenueRecord(record: VenueRecord): string[] {
  ...
  return [
    ...
    labels('pku-core'),
    labels('cssci'),
    labels('cssci-extended'),
    labels('cstpcd'),
    labels('cscd-core'),
    labels('cscd-extended'),
    labels('cast-tier'),
    labels('sjr'),
...
function parseVenueLabels(
  ...
  const definitions: Array<{
    ...
    { field: 'cssciExtendedLabels', kind: 'cssci-extended' },
    { field: 'cstpcdLabels', kind: 'cstpcd' },
    { field: 'cscdCoreLabels', kind: 'cscd-core' },
    { field: 'cscdExtendedLabels', kind: 'cscd-extended' },
    { field: 'castTierLabels', kind: 'cast-tier' },
